...
TACH data are saved in the [hard disk](#glossary) (refer to glossary below) automatically after any command that changes the data. There is no need to save manually.

## Editing the data file

TACH data are saved as a [JSON file](#glossary) (refer to glossary below). <br>
